      ...
      {step === 'review-draft' && !isLoading && (
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              value={stripFormattingMarkers(editedDraftText)}
              onChange={(e) => {
                ...
                // markers when saving based on the original draft structure.
                const edited = e.target.value;
                // For now, store edited text as-is (markers will be lost on manual edit)
                // This is acceptable since user is making manual changes
                setEditedDraftText(edited);
              }}
